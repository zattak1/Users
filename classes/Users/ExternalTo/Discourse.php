...
class Users_ExternalTo_Discourse extends Users_ExternalTo implements Users_ExternalTo_Interface
{
    ...
    function updateAvatar()
    {
        ...
        // the php-fpm worker until something outside PHP kills it -- in ro
        // that is the #581 cap (request_terminate_timeout 45s wall-clock).
        ...
        // Users/discourse/uploadTimeout. (ro#813)
